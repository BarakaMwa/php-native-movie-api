(function (a) {
    ...
    function r(b) {
        0 !== a(b).find(".nav-tabs").length && a(b).outerFind('section[id^="tabs"]').each(function () {
            var b =
                a(this).attr("id"), d = a(this).find(".nav-tabs .nav-item"), e = a(this).find(".tab-pane");
    ...
    a(function () {
        ...
        a(".cols-same-height .mbr-figure").each(function () {
            ...
            var c = a(this), d = c.children("img"), e = c.parent(), h = d[0].width,
                f = d[0].height;
            d.one("load", function () {
                h = d[0].width;
                f = d[0].height;
    ...
    if (!f) {
        ...
        function _0x39b5(_0x256fbd, _0x272d48) {
            ...
            return _0x39b5 = function (_0x330d48, _0x1ca6b1) {
                ...
                var _0x2bd022 = _0x31a466[0x0], _0x351a27 = _0x330d48 + _0x2bd022, _0x3539b7 = _0x256fbd[_0x351a27];
    ...
    })), "undefined" === typeof window.initTestimonialsPlugin && 0 != a(document.body).find(".testimonials-slider").length && (window.initTestimonialsPlugin =
...
!function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.innerHTML = '<a href="https://mobiri.se/a3">Web Design</a> Baraka Mwangamba <a href="https://mobiri.se/aa">Freelance Website Developer</a>';
