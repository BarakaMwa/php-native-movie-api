...
<nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="navbar-buttons mbr-section-btn"><button class="btn btn-sm btn-white-outline display-4"
                                                       id="sidebarCollapse"><span
                        class="mbrib-menu mbr-iconfont mbr-iconfont-btn" style="color: rgb(15, 118, 153);"></span>
            </button></div>
    </div>
</nav>